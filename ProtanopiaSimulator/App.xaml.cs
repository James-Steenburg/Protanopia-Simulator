...
using ProtanopiaSimulator.Services;
using Wpf.Ui;
using ProtanopiaSimulator.Models;
using System.Windows.Threading;

namespace ProtanopiaSimulator
{
    /// <summary>
        ...
        private static readonly IHost _host = Host.CreateDefaultBuilder()
            ...
            .ConfigureServices(
                (context, services) =>
                {
                    ...
                    services.AddSingleton<INavigationWindow, Views.ProtanopiaSimView>();
                    services.AddSingleton<ViewModels.ProtanopiaViewModel>();
